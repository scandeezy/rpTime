...
public class CompanyService implements Service<Company>
{
	...
	public Company toCompany(Entity entity)
	{
		...
		company.setHeader((String)entity.getProperty(COMPANY_NAME_KEY));
		company.setPhone((String)entity.getProperty(COMPANY_NAME_KEY));
		company.setStartDayOfWeek((Integer)entity.getProperty(COMPANY_PHONE_KEY));
